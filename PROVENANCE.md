...
and are licensed under the Apache License, Version 2.0. The one dependency is the Zig standard
library, a permissively licensed standard library whose notice is in [NOTICE.md](NOTICE.md).
